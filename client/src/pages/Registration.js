  ...
  return (
    ...
    <div className="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
                <div className="container text-center py-5">
                    <h1 className="display-3 text-white mb-4 animated slideInDown">Register</h1>
    ...
    <div className="container">
      <div className="row">
        <div className="col-sm-6">
            ...
            <div className="col-sm-6" style={{border:"#f2f2f2 solid 1px",borderRadius:"20px",padding:"20px",marginTop:"20px"}}>
              ...
              <div>
                <form className="" onSubmit={handleSubmit}>
                  ...
                  <div className="">
                    ...
                    <div className=" mb-12">
                      <label for="cars" className="pb-2 pt-2">
                        Choose a course:
                      </label>
                      ...
                      >
                        ...
                        <option value="Etc">Electronic & Communication</option>
                      </select>
                    </div>
                  </div>

                  <div className="row m-3">
                    <div className="col-sm-12  px-3 place-content-center">
                      <button
                        type="submit"
